...
esp32-config: ## Generate esp32/src/config.h from env vars (ESP32_WIFI_SSID, ESP32_WIFI_PASS; ESP32_SERVER_URL defaults to http://tp25.service.dc1.consul:8088). BLE identifiers default to the legacy TP25 and can be overridden with ESP32_BLE_NAME / ESP32_BLE_SERVICE_UUID / ESP32_BLE_WRITE_CHAR_UUID / ESP32_BLE_NOTIFY_CHAR_UUID.
	...
	@BLE_NAME="$${ESP32_BLE_NAME:-Thermopro}"; \
	BLE_SERVICE_UUID="$${ESP32_BLE_SERVICE_UUID:-1086fff0-3343-4817-8bb2-b32206336ce8}"; \
	BLE_WRITE_CHAR_UUID="$${ESP32_BLE_WRITE_CHAR_UUID:-1086fff1-3343-4817-8bb2-b32206336ce8}"; \
	BLE_NOTIFY_CHAR_UUID="$${ESP32_BLE_NOTIFY_CHAR_UUID:-1086fff2-3343-4817-8bb2-b32206336ce8}"; \
	{ \
