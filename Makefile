...
esp32-config: ## Generate esp32/src/config.h from env vars (ESP32_WIFI_SSID, ESP32_WIFI_PASS; ESP32_SERVER_URL defaults to http://tp25.service.dc1.consul:8080)
	...
	@echo "#define SERVER_URL \"$${ESP32_SERVER_URL:-http://tp25.service.dc1.consul:8080}\"" >> esp32/src/config.h
...
esp32-upload: esp32-build ## Build and upload firmware to server for OTA
	curl -X POST $${ESP32_SERVER_URL:-http://tp25.service.dc1.consul:8080}/api/firmware/upload \
